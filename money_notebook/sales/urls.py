...
urlpatterns = [
    ...
    path("clientes/<int:client_id>/atualizar", views.update_client, name="update_client"),
    ...
    path("contas/<int:account_id>/atualizar", views.update_account, name="update_account"),
